...
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public List<String> ViewDropDownListElements(WebDriver driver, WebElement ele) {	
		Select op= new Select(ele);
		List<WebElement> ListWebEmelemnt = op.getOptions();
		List<String> actualValues = new ArrayList<String>();
		for(WebElement ref : ListWebEmelemnt) {
